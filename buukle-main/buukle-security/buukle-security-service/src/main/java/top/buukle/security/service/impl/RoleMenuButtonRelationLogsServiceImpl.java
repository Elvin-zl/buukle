...
public class RoleMenuButtonRelationLogsServiceImpl implements RoleMenuButtonRelationLogsService{
     ...
     */
    @Override
    public RoleMenuButtonRelationLogs selectByPrimaryKey(Integer id) {
        if(id == null){
    ...
    public FuzzyResponse fuzzySearch(String text, String fieldName) {
        ...
        // return new FuzzyResponse.Builder().build(roleMenuButtonRelationLogsMapper.fuzzySearch(fuzzyVo));
        return null;
    }
