...
import com.spawpaw.mybatis.generator.gui.configure.DatabaseConfig;
import com.spawpaw.mybatis.generator.gui.configure.ProjectConfig;
...
public class MBGRunner {
    ...
    public String generate() throws SQLException {
        ...
        String modulePrefix = split[split.length - 1].replace("/","");
        // ========================================================================================================model
        JavaModelGeneratorConfiguration javaModelGeneratorConfiguration = new JavaModelGeneratorConfiguration();
        javaModelGeneratorConfiguration.setTargetPackage(projectConfig.entityPackage.getValue().replace(" ", ""));
        javaModelGeneratorConfiguration.setTargetProject(projectDir() + modulePrefix + "-entity/" + projectConfig.entityDir.getValue());
        ...
        sqlMapGeneratorConfiguration.setTargetProject(projectDir()  + modulePrefix + "-web/" + projectConfig.mapperDir.getValue());
        ...
        javaClientGeneratorConfiguration.setTargetProject(projectDir() + modulePrefix + "-dao/"  + projectConfig.daoDir.getValue());
