...
public class ButtonType {
    ...
    /**
     * 按钮类型值响应
     * @param typeOperation 按钮类型值响应
     */
    public void setTypeOperation(String typeOperation) {
        this.typeOperation = typeOperation == null ? null : typeOperation.trim();
    }
