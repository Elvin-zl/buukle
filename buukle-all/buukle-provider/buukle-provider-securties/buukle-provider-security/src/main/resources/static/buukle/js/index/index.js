...
function setThemeAppearance(userInfo) {
    if(null == userInfo.theme ){
        $('#themeCss').attr('href','/static/buukle/css/theme/theme-nigntStar.css');
        $('#currentDBTheme').val('/static/buukle/css/theme/theme-nigntStar.css');
        $('#tempTheme').val('/static/buukle/css/theme/theme-nigntStar.css');
    }else{
