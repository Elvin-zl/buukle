...
import top.buukle.consumer.www.dao.UserArticlePraiseRelationMapper;
    ...
    */
    ...
    public void updateArticlePraise(UserArticlePraiseRelationQuery query, HttpServletRequest request){
        ...
        if(!query.getPraiseFlag()){
            // 赞数+1
            articleInfoQuery.setLikeNumber((null == articleInfoDetail.getLikeNumber() ? 0L : 1L ) + NumberUtil.INTEGER_ONE);
            // 插入点赞关系记录
