package top.buukle.consumer.www.controller.security;
...
public class SecurityController {
     ...
     * @return
     */
    @RequestMapping("/updateUserBasicResource")
    @ResponseBody
    public BaseResponse updateUserBasicResource(User user, HttpServletRequest httpServletRequest){
        return securityClient.updateUserBasicResource(user,httpServletRequest);
    }
