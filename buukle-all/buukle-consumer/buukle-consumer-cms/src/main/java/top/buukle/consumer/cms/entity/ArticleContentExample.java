...
public class ArticleContentExample {
    ...
    /**
     */
    public ArticleContentExample orderBy(String orderByClause) {
    ...
    /**
     */
    public ArticleContentExample orderBy(String ... orderByClauses) {
    ...
    public static class Criteria extends GeneratedCriteria {
        /**
         */
        private ArticleContentExample example;

        /**
         */
        protected Criteria(ArticleContentExample example) {
            super();
        ...
        /**
         */
        public ArticleContentExample example() {
            return this.example;
        }
