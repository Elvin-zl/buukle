...
public class ArticleDescServiceImpl implements ArticleDescService{
    ...
    */
    ...
    public PageResponse<ArticleDesc> getArticleDescList(ArticleDescQuery query, PageBounds pageBounds) {
        ...
        //List<ArticleDesc> list = mapper.getArticleDescList(query);
        List<ArticleDesc> list = new ArrayList<>();
    ...
    */
    ...
    public List<FuzzySearchListVo> fuzzySearchByName(String fuzzyText) {
        List<ArticleDesc> list = new ArrayList<>();
        //List<ArticleDesc> list = mapper.fuzzySearchByName("%" + fuzzyText + "%");
    ...
    */
    @Override
    public ArticleDesc insert(ArticleDesc record) throws Exception{
    ...
    */
    @Override
    public int update(ArticleDesc record) throws Exception{
