...
import top.buukle.consumer.portal.dao.AsyncTaskMapper;
...
public class AsyncTaskServiceImpl implements AsyncTaskService {
    ...
    */
    @Override
    public BaseResponse updateAsyncTaskForTask(AsyncTaskQuery query) {
        AsyncTaskExample asyncTaskExample = new AsyncTaskExample();
        AsyncTaskExample.Criteria criteria = asyncTaskExample.createCriteria();
        criteria.andIdEqualTo(query.getId());
        query.setGmtModified(new Date());
        query.setModifier("PORTAL_TASK");
        query.setModifierCode("PORTAL_TASK");
        asyncTaskMapper.updateByExampleSelective(query,asyncTaskExample);
        return new BaseResponse.Builder().buildSuccess();
    }
