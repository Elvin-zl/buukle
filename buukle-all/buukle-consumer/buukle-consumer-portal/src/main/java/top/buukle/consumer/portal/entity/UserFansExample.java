...
public class UserFansExample {
    ...
    /**
     */
    public UserFansExample orderBy(String orderByClause) {
    ...
    /**
     */
    public UserFansExample orderBy(String ... orderByClauses) {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andUserFansIdLikeInsensitive(String value) {
            addCriterion("upper(user_fans_id) like", value.toUpperCase(), "userFansId");
            return (Criteria) this;
        }
    ...
    public static class Criteria extends GeneratedCriteria {
        /**
         */
        private UserFansExample example;

        /**
         */
        protected Criteria(UserFansExample example) {
            super();
        ...
        /**
         */
        public UserFansExample example() {
            return this.example;
        }
